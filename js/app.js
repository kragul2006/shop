...
const PRODUCTS = [
  ...
  { id:5, name:"Cotton Bedsheet Set (Queen)", category:"Home Decor", price:2599, discount:15, colors:["#20B2AA","#FFFFFF"], variants:["Queen"], description:"Breathable 100% cotton bedsheet set with deep pockets and matching pillow covers. Soft wash-friendly fabric.", featured:true, isNew:false, image:"suit", stock:40, reviews:[{author:"Priya N.",rating:5,comment:"Soft and fits my mattress perfectly.",date:"2026-04-05"}] },
  { id:6, name:"Down Alternative Pillow (Set of 2)", category:"Home Decor", price:1399, discount:10, colors:["#FF69B4","#F0F0F0"], variants:["Set of 2"], description:"Hypoallergenic pillows with plush loft and good support. Machine washable cover for easy care.", featured:false, isNew:true, image:"saree2", stock:80, reviews:[] },
  { id:7, name:"Bath Towel Set (4 pcs)", category:"Bathroom utensils", price:999, discount:5, colors:["#8B4513","#F5F5F5"], variants:["4 pcs"], description:"Absorbent cotton towel set with quick-dry weave and soft finish. Includes two bath towels and two hand towels.", featured:false, isNew:false, image:"agarbatti", stock:120, reviews:[{author:"Leela K.",rating:5,comment:"Soft and absorbent — very happy.",date:"2026-01-20"}] },
  { id:8, name:"Shower Curtain with Hooks", category:"Bathroom utensils", price:699, discount:0, colors:["#FFFFFF","#2F4F4F"], variants:["Single"], description:"Stylish shower curtain with rust-resistant hooks and water-repellent coating. Multiple designs available.", featured:false, isNew:true, image:"pooja", stock:55, reviews:[] },
