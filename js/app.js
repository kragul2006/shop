...
const PRODUCTS = [
  ...
  { id:2, name:"Water Bottle Kids(2L+700ML+300ML)",
    ...
    variants:[], 
    description:"ABC Water Bottles(2L+700ml+300ml) Leak-proof, BPA free Motivational Sports Bottle 3000 ml Plastic Bottle (Pack of 3, Multicolor)", featured:false, isNew:true, 
...
{ id:3, name:"labubu water bottle",
    ...
    colors:["#e524cb","#0d79de","#e9340f"],
    variants:[], 
    description:" LABUBU water Bottle Bunny Cartoon 750 ml Plastic Bottle (Pack of 1, Multicolor)", featured:false, isNew:true, 
    ...
    { id:4, name:"BOTMOSAI grey Water Bottle 1 Litre",
    category:"Home Goods",
    price:50, discount:0,
    colors:["#e524cb","#0d79de","#e9340f"],
    variants:[],
    description:"BOTMOSAICP1GRY 1000 ml Plastic Bottle (Pack of 1, Black)", featured:false, isNew:true, 
